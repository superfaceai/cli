...
describe('lint CLI command', () => {
  ...
  it('lints a valid and an invalid map - short format', async () => {
    await Lint.run(['--outputFormat', 'short', './fixtures/strict.suma', './fixtures/invalid.suma'])
  ...
  it('lints a valid and an invalid map - json format', async () => {
    await Lint.run(['--outputFormat', 'json', './fixtures/strict.suma', './fixtures/invalid.suma'])
